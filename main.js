...
dailyBtn.addEventListener("click", function(e){
    ...
    document.getElementById("exerciseCurrent").textContent = jsonData[3].timeframes.daily.current + "hr";
    document.getElementById("exercisePrev").textContent = "Yesterday - " + jsonData[3].timeframes.daily.previous + "hr";
    document.getElementById("socialCurrent").textContent = jsonData[4].timeframes.daily.current + "hr";
...
weekBtn.addEventListener("click", function(e){
    ...
    document.getElementById("exerciseCurrent").textContent = jsonData[3].timeframes.weekly.current + "hrs";
    document.getElementById("exercisePrev").textContent = "Last week - " + jsonData[3].timeframes.weekly.previous + "hrs";
    document.getElementById("socialCurrent").textContent = jsonData[4].timeframes.weekly.current + "hrs";
...
monthBtn.addEventListener("click", function(e){
    ...
    document.getElementById("exerciseCurrent").textContent = jsonData[3].timeframes.monthly.current + "hrs";
    document.getElementById("exercisePrev").textContent = "Last month - " + jsonData[3].timeframes.monthly.previous + "hrs";
    document.getElementById("socialCurrent").textContent = jsonData[4].timeframes.monthly.current + "hrs";
